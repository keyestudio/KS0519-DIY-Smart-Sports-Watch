...
KSRobot_Display_Clock::KSRobot_Display_Clock(KSRobot_Display* pDisplay)
{
  _pDisplay = pDisplay;
  _hourWidth = 1;
  _minWidth = 1;
...
void KSRobot_Display_Clock::setClockDial(int16_t x, int16_t y, uint16_t r)
{
  _x = x;
  _y = y;
  _r = r;
...
void KSRobot_Display_Clock::setPointerColor(uint16_t hc, uint16_t mc, uint16_t sc)
{
  _hourColor = hc;
  _minColor = mc;
  _secColor = sc;
...
void KSRobot_Display_Clock::setPointerLength(uint16_t hl, uint16_t ml, uint16_t sl)
{
  _hourLen = hl;
  _minLen = ml;
  _secLen = sl;
...
void KSRobot_Display_Clock::setDialColor(uint16_t border, uint16_t background)
{
  _background = background;
  _borderColor = border;
}

void KSRobot_Display_Clock::setPointerWidth(uint16_t hw, uint16_t mw, uint16_t sw)
{
  _hourWidth = hw;
  _minWidth = mw;
  _secWidth = sw;
...
void KSRobot_Display_Clock::showDial()
{
...
void KSRobot_Display_Clock::updateClock(uint8_t h, uint8_t m, uint8_t s)
{
