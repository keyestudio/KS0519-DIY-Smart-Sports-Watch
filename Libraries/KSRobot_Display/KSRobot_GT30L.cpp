#include "KSRobot_GT30L.h"

static KSRobot_GT30L GT30L;
...
void KSRobot_GT30L::readBytes(uint32_t addr, uint8_t count, uint8_t* pBuf)
{
  SPI.begin();
...
void KSRobot_GT30L::unicodeToGB2312(uint8_t* pUnicode, uint8_t* pGB2312)
{
  uint32_t addr;
  uint8_t result=0;
  uint32_t h;
...
uint32_t KSRobot_GT30L::getGTAddr(uint8_t* pGB2312, eCHARACTER_HEIGHT type)
{
  uint32_t temp = 0;
