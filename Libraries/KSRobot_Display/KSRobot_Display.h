#ifndef KSROBOT_DISPLAY_H
#define KSROBOT_DISPLAY_H

#include "Arduino.h"
#include "KSRobot_Types.h"
#include "KSRobot_Character.h"
#include "Print.h"
...
class KSRobot_Display : public Print
{
  public:
    KSRobot_Display(uint16_t width, uint16_t height);
