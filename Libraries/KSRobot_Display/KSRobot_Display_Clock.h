#ifndef KSRobot_DISPLAY_CLOCK_H
#define KSRobot_DISPLAY_CLOCK_H
...
class KSRobot_Display_Clock {
  public:
    KSRobot_Display_Clock(KSRobot_Display* pDisplay);
